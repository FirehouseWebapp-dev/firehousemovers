...
class Dispatch(models.Model):
    ...
    crew_leads = models.ForeignKey(CrewStaff,on_delete=models.DO_NOTHING,null=True, blank=True)
    ...
    labels_for_speedy_inventory = models.CharField(max_length=200, null=True, blank=True)
...
class Evaluation(models.Model):
    ...
    inspector = models.ForeignKey(UserProfile, on_delete=models.CASCADE,null=True, blank=True)  
