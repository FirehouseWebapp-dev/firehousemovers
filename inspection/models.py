...
class Onsite_inspection(models.Model):
    ...
    inspector = models.ForeignKey(UserProfile,on_delete=models.CASCADE,related_name="inspector_inspections")
    customer_name = models.CharField(max_length=255)
    customer_phone = models.CharField(max_length=20)
    pickup_address = models.TextField()
    delivery_address = models.TextField()
    crew_leader = models.ForeignKey(CrewStaff,on_delete=models.DO_NOTHING,null=True, blank=True,related_name="crew_leader_inspections")
    crew_members = models.ManyToManyField(CrewStaff, blank=True, related_name="crew_member_inspections")

    # Prior to Move
    materials_check_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    vehicle_inventory_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    customer_communication_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    parking_arranged_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)

    # At Pickup
    customer_greeted_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    crew_introduction_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    initial_walkthrough_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    estimate_comparison_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    damage_inspection_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    paperwork_signed_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    valuables_secured_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    protection_setup_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    photos_sent_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    inventory_management_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    furniture_disassembly_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    parts_management_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    loading_quality_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    padding_used_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    load_secured_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    final_walkthrough_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)    
    customer_initials_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    follow_instructions_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    truck_prepared_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    dispatch_complete_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)

    # At Drop Off
    dispatch_unload_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    damage_inspection_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    protection_setup_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    placement_accuracy_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    pad_management_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    furniture_reassembly_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    customer_walkthrough_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)
    vehicle_inspection_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)    
    final_charges_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)   
    customer_review_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)   
    paperwork_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)   
    payment_collection_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)   
    video_testimonial_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)   
    completion_notice_rating = models.IntegerField(choices=[(i, i) for i in range(1,6)], null=True, blank=True)   
    
    # Final Review
    comments = models.TextField(blank=True, null=True)
    customer_feedback = models.TextField(blank=True, null=True)
    prior_move_score = models.DecimalField(max_digits=3, decimal_places=2, default=0.0,null=True, blank=True)
    pickup_score = models.DecimalField(max_digits=3, decimal_places=2, default=0.0,null=True, blank=True)
    dropoff_score = models.DecimalField(max_digits=3, decimal_places=2, default=0.0,null=True, blank=True)
    overall_score = models.DecimalField(max_digits=3, decimal_places=2, default=0.0,null=True, blank=True)
    ...
    def get_final_review(self):
        ...
        return f"Prior to Move Score: {scores['Prior to Move Score']}/5\n" \
