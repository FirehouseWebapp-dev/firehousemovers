    ...
    class Meta:
        ...
        widgets = {
            ...
            **{
                ...
                for field_name in [
                    'materials_check_rating', 'vehicle_inventory_rating', 'customer_communication_rating',
                    'parking_arranged_rating', 'customer_greeted_rating', 'crew_introduction_rating',
                    'initial_walkthrough_rating', 'estimate_comparison_rating', 'damage_inspection_rating',
                    'paperwork_signed_rating', 'valuables_secured_rating', 'protection_setup_rating',
                    'photos_sent_rating', 'inventory_management_rating', 'furniture_disassembly_rating',
                    'parts_management_rating', 'loading_quality_rating', 'padding_used_rating',
                    'load_secured_rating', 'final_walkthrough_rating', 'customer_initials_rating',
                    'follow_instructions_rating', 'truck_prepared_rating', 'dispatch_complete_rating',
                    'dispatch_unload_rating', 'protection_setup_rating', 'placement_accuracy_rating',
                    'pad_management_rating', 'furniture_reassembly_rating', 'customer_walkthrough_rating',
                    'vehicle_inspection_rating', 'final_charges_rating', 'customer_review_rating',
                    'paperwork_rating', 'payment_collection_rating', 'video_testimonial_rating',
