...
from inventory_app.views import Add_uniform_view, uniform_inventory_view,Issue_uniform_view,Return_uniform_view,Employee_view,Reports_view,inventory_view,get_uniforms
